...
| `PHOTO_S3_BUCKET` | api | bucket name for weigh-in photos |
| `PHOTO_S3_ENDPOINT` | api | the provider's S3 API URL (R2: `https://<account-id>.r2.cloudflarestorage.com`) |
| `PHOTO_S3_ACCESS_KEY_ID` | api | bucket access key |
| `PHOTO_S3_SECRET_ACCESS_KEY` | api | bucket secret key |
